...
INSERT INTO parcelle (parcelle_id,surface,addresse,code_postal) VALUES (42,12000,'5 rue des Pins',(SELECT code_postal FROM ville WHERE ville.nom = 'Montreuil'));
INSERT INTO parcelle (parcelle_id,surface,addresse,code_postal) VALUES (41,14000,'6 rue des Arbres',(SELECT code_postal FROM ville WHERE ville.nom = 'Paris'));
INSERT INTO parcelle (parcelle_id,surface,addresse,code_postal) VALUES (98,698000,'51 rue de la Soif',(SELECT code_postal  FROM ville WHERE ville.nom = 'Montreuil'));
